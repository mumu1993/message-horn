$(function() {
	...
	if (exist == 2) {
		window.location = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx8663a265c1ddd949&redirect_uri=http%3A%2F%2F2.wxcyt.applinzi.com%2Fchuanyintong%2Findex.php%2FHome%2FWxFB%2Findex%3Fid%3D1&response_type=code&scope=snsapi_userinfo&state=#wechat_redirect"
	}
	...
	$("#user-name").keyup(function() {
		...
		if (reg1.test(userName) && userName !== "") {
			$.ajax({
					url: "http://2.wxcyt.applinzi.com/chuanyintong/index.php/Home/WxFB/IsName/nickname/",
					type: 'post',
					data: {
						nickname: userName
					},
	...
	$('#submit').on('click', function() {
		...
		console.log(openid)
		$.ajax({
			url: "http://2.wxcyt.applinzi.com/chuanyintong/index.php/Home/WxFB/Exist",
			type: 'post',
			data: {
				openid: openid,
				phone_num: phoneNum,
