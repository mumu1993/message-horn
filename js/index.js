$(function() {
	...
	function article() {
		...
		$.ajax({
			type: "post",
			url: "http://www.qingnianjuhe.com/chuanyintong/index.php/Home/WxFB/ArticleList",
			data: {
				sid:0,
				openid: openid
			},
	...
	function draft() {
		...
		$.ajax({
			type: "post",
			url: "http://www.qingnianjuhe.com/chuanyintong/index.php/Home/WxFB/ArticleDList",
			data: {
				sid:0,
				openid: openid
			},
	...
	$(document).on('click', '#page2>.card', function() {
		...
		var buttons1 = [{
				...
				onClick: function() {
					...
					$.ajax({
						type: "post",
						url: "http://www.qingnianjuhe.com/chuanyintong/index.php/Home/WxFB/GetDataTxt",
						data: {
							tid: tid
						},
						complete: function() {
				...
				onClick: function() {
					$.confirm('确定要删除文章吗？', function() {
						...
						$.ajax({
							type: "post",
							url: "http://www.qingnianjuhe.com/chuanyintong/index.php/Home/WxFB/DTitle",
							data: {
								tid: tid
							},
							complete:function(){
	...
	$("#publish,#save").click(function() {
		$("#page1").hide();
		var sendData = $.ajax({
			url: "http://www.qingnianjuhe.com/chuanyintong/index.php/Home/WxFB/SetDataTxt",
			type: "post",
			data: {
				DataTxt: html,
				Tid: pageIndex
		...
		var sendTitle = $.ajax({
			url: "http://www.qingnianjuhe.com/chuanyintong/index.php/Home/WxFB/SetTitleName",
			type: "post",
			data: {
				title: title,
				Tid: pageIndex
	...
	function creatDraft() {
		...
		var setName = $.ajax({
			type: "post",
			url: "http://www.qingnianjuhe.com/chuanyintong/index.php/Home/WxFB/SetTxtUser",
			data: {
				Tid: pageIndex,
				Name: writer
			},
		...
		var setInn = $.ajax({
			url: "http://www.qingnianjuhe.com/chuanyintong/index.php/Home/WxFB/SetDraft",
			type: "post",
			data: {
				Tid: pageIndex
			},
	...
	function creatPage() {
		...
		var setInn = $.ajax({
			url: "http://www.qingnianjuhe.com/chuanyintong/index.php/Home/WxFB/SetFb",
			type: "post",
			data: {
				Tid: pageIndex
			},
